...
ECHO *                                    * >> %logfile%
ECHO ************************************** >> %logfile%
pskill \\s09202isp000 nsb.desktop.client.exe >> %logfile%
pskill \\s09202REG001 nsb.pos.client.exe >> %logfile%
pskill \\s09202REG002 nsb.pos.client.exe >> %logfile%
ECHO. >> %logfile%
...
ECHO *                                    * >> %logfile%
ECHO ************************************** >> %logfile%
psexec \\s09202isp000 c:\nsb\stopservices.bat >> %logfile%
psexec \\s09202REG001 c:\nsb\stopservices.bat >> %logfile%
psexec \\s09202REG002 c:\nsb\stopservices.bat >> %logfile%
...
ECHO *                                    * >> %logfile%
ECHO ************************************** >> %logfile%
xcopy /s %PROJECTLOCATION%\CANADA\ISP\* 		\\s09202isp000\c$\ /E /H /I /V /Y >> %logfile%
xcopy /s %PROJECTLOCATION%\CANADA\REGISTERS\* 	\\s09202REG001\c$\ /E /H /I /V /Y >> %logfile%
xcopy /s %PROJECTLOCATION%\CANADA\REGISTERS\* 	\\s09202REG002\c$\ /E /H /I /V /Y >> %logfile%
ECHO. >> %logfile%
ECHO COPY SECTION COMPLETE >> %logfile%
ECHO. >> %logfile%
psexec \\s09202isp000 c:\streams.exe -d -s C:\nsb\coalition\dotnet\
psexec \\s09202reg001 c:\streams.exe -d -s C:\nsb\coalition\dotnet\
psexec \\s09202reg002 c:\streams.exe -d -s C:\nsb\coalition\dotnet\
...
ECHO *                                    * >> %logfile%
ECHO ************************************** >> %logfile%
psexec \\s09202isp000 shutdown /r /f /t 300 >> %logfile%
psexec \\s09202REG001 shutdown /r /f /t 600 >> %logfile%
psexec \\s09202REG002 shutdown /r /f /t 600 >> %logfile%
ECHO. >> %logfile%
