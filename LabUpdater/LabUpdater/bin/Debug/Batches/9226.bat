...
ECHO *                                    * >> %logfile%
ECHO ************************************** >> %logfile%
pskill \\s09226isp000 nsb.desktop.client.exe >> %logfile%
pskill \\s09226REG001 nsb.pos.client.exe >> %logfile%
pskill \\s09226REG002 nsb.pos.client.exe >> %logfile%
ECHO. >> %logfile%
...
ECHO *                                    * >> %logfile%
ECHO ************************************** >> %logfile%
psexec \\s09226isp000 c:\nsb\stopservices.bat >> %logfile%
psexec \\s09226REG001 c:\nsb\stopservices.bat >> %logfile%
psexec \\s09226REG002 c:\nsb\stopservices.bat >> %logfile%
...
ECHO *                                    * >> %logfile%
ECHO ************************************** >> %logfile%
xcopy /s %PROJECTLOCATION%\US\ISP\* 		\\s09226isp000\c$\ /E /H /I /V /Y >> %logfile%
xcopy /s %PROJECTLOCATION%\US\REGISTERS\* 	\\s09226REG001\c$\ /E /H /I /V /Y >> %logfile%
xcopy /s %PROJECTLOCATION%\US\REGISTERS\* 	\\s09226REG002\c$\ /E /H /I /V /Y >> %logfile%
ECHO. >> %logfile%
ECHO COPY SECTION COMPLETE >> %logfile%
ECHO. >> %logfile%
psexec \\s09226isp000 c:\streams.exe -d -s C:\nsb\coalition\dotnet\
psexec \\s09226reg001 c:\streams.exe -d -s C:\nsb\coalition\dotnet\
psexec \\s09226reg002 c:\streams.exe -d -s C:\nsb\coalition\dotnet\
...
ECHO *                                    * >> %logfile%
ECHO ************************************** >> %logfile%
psexec \\s09226isp000 shutdown /r /f /t 300 >> %logfile%
psexec \\s09226REG001 shutdown /r /f /t 600 >> %logfile%
psexec \\s09226REG002 shutdown /r /f /t 600 >> %logfile%
ECHO. >> %logfile%
