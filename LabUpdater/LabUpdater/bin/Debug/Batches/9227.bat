...
ECHO *                                    * >> %logfile%
ECHO ************************************** >> %logfile%
pskill \\s09227isp000 nsb.desktop.client.exe >> %logfile%
pskill \\s09227REG001 nsb.pos.client.exe >> %logfile%
pskill \\s09227REG002 nsb.pos.client.exe >> %logfile%
ECHO. >> %logfile%
...
ECHO *                                    * >> %logfile%
ECHO ************************************** >> %logfile%
psexec \\s09227isp000 c:\nsb\stopservices.bat >> %logfile%
psexec \\s09227REG001 c:\nsb\stopservices.bat >> %logfile%
psexec \\s09227REG002 c:\nsb\stopservices.bat >> %logfile%
...
psexec \\s09227isp000 c:\streams.exe -d -s C:\nsb\coalition\dotnet\bin\
psexec \\s09227reg001 c:\streams.exe -d -s C:\nsb\coalition\dotnet\bin\
psexec \\s09227reg002 c:\streams.exe -d -s C:\nsb\coalition\dotnet\bin\
xcopy /s %PROJECTLOCATION%\US\ISP\* 		\\s09227isp000\c$\ /E /H /I /V /Y >> %logfile%
xcopy /s %PROJECTLOCATION%\US\REGISTERS\* 	\\s09227REG001\c$\ /E /H /I /V /Y >> %logfile%
xcopy /s %PROJECTLOCATION%\US\REGISTERS\* 	\\s09227REG002\c$\ /E /H /I /V /Y >> %logfile%
ECHO. >> %logfile%
...
ECHO *                                    * >> %logfile%
ECHO ************************************** >> %logfile%
psexec \\s09227isp000 shutdown /r /f /t 300 >> %logfile%
psexec \\s09227REG001 shutdown /r /f /t 600 >> %logfile%
psexec \\s09227REG002 shutdown /r /f /t 600 >> %logfile%
ECHO. >> %logfile%
